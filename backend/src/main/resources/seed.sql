...
-- INCIDENTS
-- ============================================================
INSERT INTO incidents (id, reported_by, trip_id, type, description, status, created_at, resolved_at) VALUES
(1, 5,  3, 'route-deviation', 'Vehicle took an unregistered turn near the taxi rank. My child was on board.', 'open',          '2026-09-22 07:42:00', NULL),
(2, 10, 2, 'breakdown',       'Vehicle broke down on Route B. Learners transferred to backup vehicle.',        'investigating', '2026-09-21 16:10:00', NULL),
(3, 5,  1, 'late-pickup',     'Driver arrived 20 minutes late for morning pickup.',                            'resolved',      '2026-09-19 08:05:00', '2026-09-19 14:00:00');
